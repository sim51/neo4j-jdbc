...
public class TransactionTest extends Neo4jJdbcTest {
    ...
    public void testManualCommit() throws Exception {
        try {
            ...
            if (sqle.getMessage().contains("not supported")) return;
            throw sqle;
        }
    }
    ...
    private void assertNodeVisibleInOtherTransaction(final long nodeId, final boolean exists) throws InterruptedException {
