...
import org.neo4j.jdbc.helpers.TestAuthenticationFilter;
import org.neo4j.jdbc.helpers.TestServer;
...
public abstract class Neo4jJdbcIntegrationTest
{
    @Rule public Mute muteStdOut = Mute.muteAll();
    ...
    public enum Mode
    {
        embedded, mem, server, server_tx, server_auth
    }
    ...
    public Neo4jJdbcIntegrationTest( Mode mode ) throws SQLException
    {
        this.mode = mode;
